...
```{r echo=FALSE}
kable(tab_deltaper_prot,caption = "Table 2.  Descriptive statistics for percent changes in proteins and other variables, for participants with proteomics data, by treatment group.  Statistics given are median (25th %ile, 75th %ile).  P-values are from the Mann-Whitney test.")
```
\
